...
run:
	...
	@go run ./cmd/api -port=4000 -env=development -limiter-burst=5 -limiter-rps=2 -limiter-enabled=true -cors-trusted-origins="http://localhost:9000 http://localhost:9001"
